...
$time = time();
queryMysql("INSERT INTO messages VALUES('$user','$view', '$pm', $time, '$text', NULL )");
 }
 }
 if ($view != "")
 {
...
queryMysql("DELETE FROM messages WHERE id=$erase AND recip='$user'");
 ...
 $query = "SELECT * FROM messages WHERE recip='$view' ORDER BY id ";
...
echo "whispered: <span class='whisper'>&quot;" .$row['text']. "&quot;</span> ";
if ($row['recip'] == $user)
...
echo "<br>";
 ...
 echo "<br><button><a data-role='button'
href='messages.php?view=$view'>Refresh messages</a></button>";
?>
 </div><br>
 </body>
</html>